...
const youtube = new YouTube("AIzaSyBVHwyszOrMUINbvW8agwN_1wXzJdcc0xc"); //تعديل اساسي سوي اي بي اي جديد
const hastebins = require("hastebin-gen");
const getYoutubeID = require("get-youtube-id");
const yt_api_key = "AIzaSyBVHwyszOrMUINbvW8agwN_1wXzJdcc0xc"; ///تعديل اساسي سوي اي بي اي جديد
...
client.on("ready", () => {
  ...
  client.user.setActivity(`ArabWorld2`, { type: "WATCHING" });
});
...
\`شرح البوت من خلال بلازما \` : <شرح البوت عن طريق الاوامر >
`);
        })
        .then(e => {
          message.react("✅");
...
\`${prefix}np\` : عرض مايتم تشغيله الان [np] 
\`${prefix}repeat\` : تكرار الاغنية 
\`تشغيل البوت عن طريق البريفكس المطلوب \` : <شرح مبسط للبوت من خلال الاوامر>
